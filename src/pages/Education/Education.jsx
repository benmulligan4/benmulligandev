    ...
    return (
                ...
                <section className="timeline mb-16">
                    ...
                    <ol className="timeline-list space-y-8">
                        <li className="timeline-item">
                            ...
                            <p className="timeline-text text-gray-300 italic">BSc, Computer Science with Industrial
                                Placement</p>
                        ...
                        <li className="timeline-item">
                            ...
                            <p className="timeline-text text-gray-300">
                                <span className="font-semibold">A Levels:</span> Business Studies (A*), Computer Science
                                (A), Mathematics (A) <br/>
                                <span className="font-semibold">i/GCSEs:</span> Biology (8), Chemistry (8), Physics (8),
                                Mathematics (8), Spanish (8), English (A), English Lit (A), Computer Science (7), Drama
                                (7), History (B)
                            </p>
        ...
        Virgin Money (Nationwide Group), Newcastle
                            ...
                            <ul className="list-disc list-outside pl-6 marker:text-gray-300 text-gray-300 space-y-1">
                                <li>
                                    Assisted with merging systems during Virgin Money’s integration with Nationwide,
                                    ensuring smooth data migration and minimal service disruption.
                                </li>
                                <li>
                                    Designed, developed, and maintained internal software tools to automate reporting,
                                    document generation and workflow processes, improving operational efficiency across
                                    multiple business teams.
                                </li>
                                <li>
                                    Collaborated closely with senior developers, product owners and QA engineers to
                                    design, test, and deploy new features for both internal systems and customer-facing
                                    web applications, improving efficiency, sustainability and user experience.
                                </li>
                                <li>
                                    Participating in structured web development training from internal experts and
                                    Microsoft to enhance skills in building secure, enterprise-grade web applications,
                                    with a focus on best practices for scalability, maintainability, and cybersecurity.
                                </li>
                            </ul>
                        </li>
        ...
        Blevins Franks Wealth Management Ltd, Marbella, Spain
                ...
                <section className="flex justify-end items-center gap-4 py-2">
                    <a
                        href="/Ben Mulligan Degree.jpg"
                        download
                        className="group relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-purple-500 to-indigo-400 p-0.5 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#818CF8]"
                    >
    <span
        className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-purple-500 group-hover:to-indigo-400">
      <span className="relative flex items-center justify-center gap-2 text-white font-medium">
        ...
        <i className="fas fa-arrow-right transform transition-all duration-300 group-hover:translate-x-1"></i>
                    ...
                    >
                <span
                    className="block w-full px-6 sm:px-8 py-3 sm:py-4 rounded-[11px] bg-gray-900 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-teal-400">
                  <span className="relative flex items-center justify-center gap-2 text-white font-medium">
