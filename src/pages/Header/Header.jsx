...
export default function Header() {
    ...
    useEffect(() => {
        let path = location.pathname.replace(/^\//, "") || "home";

        if (path === "education") path = "education&experience";
                ...
                <div
                    ...
                    <nav className="bg-gray-900/90 backdrop-blur-md md:rounded-full px-4 md:px-6 py-2.5">
                        ...
                        <div className={`${isMenuOpen ? 'block' : 'hidden'} md:block`}>
                            <div
                                className="flex flex-col md:flex-row md:items-center gap-2 md:gap-1 lg:gap-2 py-4 md:py-0">
